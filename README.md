...
**Tools Used:** ArcGIS + ArcGIS online + Arcade + Python + Adobe Illustrator
...
**Description:** These maps were created to support a research project, focusing on flood risk and climate change, these printed maps were taken to the Mukuru villages and annotated by locals to better understand the enviromental impacts of increased flood risk
